...
/**
 * APITaskLink Class Doc Comment
 *
 * @category    Class */
 // @description APITaskLink
/** 
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class APITaskLink implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'APITaskLink';
    ...
    /**
     * Sets task_link_id
     * @param int $task_link_id Unique ID for the Task Link record
     * @return $this
     */
    ...
    /**
     * Sets task_id
     * @param int $task_id Unique ID for the Task record being linked
     * @return $this
     */
    ...
    /**
     * Sets contact_id
     * @param int $contact_id Unique ID for a Contact linked to the Task
     * @return $this
     */
     ...
     * @param int $organisation_id Unique ID for an Organisation linked to the Task
     * @return $this
     */
    ...
    /**
     * Sets opportunity_id
     * @param int $opportunity_id Unique ID for an Opportunity linked to the Task
     * @return $this
     */
    ...
    /**
     * Sets project_id
     * @param int $project_id Unique ID for a Project linked to the Task
     * @return $this
     */
    ...
    /**
     * Sets lead_id
     * @param int $lead_id Unique ID for a Lead linked to the Task
     * @return $this
     */
