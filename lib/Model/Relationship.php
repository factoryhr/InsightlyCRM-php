...
class Relationship implements ArrayAccess
{
     ...
     * @param int $relationship_id Unique ID for the Relationship record.
     * @return $this
     */
    ...
    /**
     * Sets forward_title
     * @param string $forward_title Name of the direct Relationship.
     * @return $this
     */
    public function setForwardTitle($forward_title)
    {
        if (strlen($forward_title) > 255) {
    ...
    /**
     * Sets forward
     * @param string $forward Description of the direct Relationship.
     * @return $this
     */
    public function setForward($forward)
    {
        if (strlen($forward) > 255) {
    ...
    /**
     * Sets reverse_title
     * @param string $reverse_title Name of the inverse Relationship.
     * @return $this
     */
    public function setReverseTitle($reverse_title)
    {
        if (strlen($reverse_title) > 255) {
    ...
    /**
     * Sets reverse
     * @param string $reverse Description of the inverse Relationship.
     * @return $this
     */
    public function setReverse($reverse)
    {
        if (strlen($reverse) > 255) {
    ...
    /**
     * Sets for_contacts
     * @param bool $for_contacts Indicates whether the relationship is availble for linking Contacts.
     * @return $this
     */
     ...
     * @param bool $for_organisations Indicates whether the relationship is availble for linking Organisations.
     * @return $this
     */
