...
class CustomField implements ArrayAccess
{
     ...
     * @param string $custom_field_id The unique id of the custom field
     * @return $this
     */
    ...
    /**
     * Sets field_value
     * @param object $field_value Text, multi-line text, bit, dropdown, date value, numeric value or URL for the Custom Field.
     * @return $this
     */
