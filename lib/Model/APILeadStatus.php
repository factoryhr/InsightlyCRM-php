...
/**
 * APILeadStatus Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class APILeadStatus implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'APILeadStatus';
    ...
    public function setLeadStatus($lead_status)
    {
        if (strlen($lead_status) > 255) {
            throw new \InvalidArgumentException('invalid length for $lead_status when calling APILeadStatus., must be smaller than or equal to 255.');
        }
        if (strlen($lead_status) < 0) {
            throw new \InvalidArgumentException('invalid length for $lead_status when calling APILeadStatus., must be bigger than or equal to 0.');
        }
