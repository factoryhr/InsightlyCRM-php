...
/**
 * APIContactDate Class Doc Comment
 *
 * @category    Class */
 // @description APIContactDate
/** 
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class APIContactDate implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'APIContactDate';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['occasion_name']) && (strlen($this->container['occasion_name']) > 255)) {
            $invalid_properties[] = "invalid value for 'occasion_name', the character length must be smaller than or equal to 255.";
        }
    ...
    /**
     * Sets date_id
     * @param int $date_id Unique ID for the contact date record
     * @return $this
     */
    ...
    /**
     * Sets occasion_name
     * @param string $occasion_name Occasion name of the Contact Date (e.g. Birthday, Hire Date, etc)
     * @return $this
     */
    public function setOccasionName($occasion_name)
    {
        if (strlen($occasion_name) > 255) {
            throw new \InvalidArgumentException('invalid length for $occasion_name when calling APIContactDate., must be smaller than or equal to 255.');
        }
        if (strlen($occasion_name) < 0) {
            throw new \InvalidArgumentException('invalid length for $occasion_name when calling APIContactDate., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Sets occasion_date
     * @param \DateTime $occasion_date Occasion Date of the Contact Date, in YYYY-MM-DD HH:MM:SS format
     * @return $this
     */
