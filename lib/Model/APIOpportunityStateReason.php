...
/**
 * APIOpportunityStateReason Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class APIOpportunityStateReason implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'APIOpportunityStateReason';
     ...
     * @param int $state_reason_id The unique ID for the State Reason
     * @return $this
     */
    ...
    /**
     * Sets state_reason
     * @param string $state_reason The name of the State Reason
     * @return $this
     */
     ...
     * @param string $for_opportunity_state The state of the Opportunity: Abandoned, Lost, Open, Suspended, or Won
     * @return $this
     */
