 ...
 *
 * @category    Class */
 // @description Pipeline change api object.
/** 
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
...
class APIPipelineChange implements ArrayAccess
{
    ...
    /**
     * Sets pipeline_id
     * @param int $pipeline_id ID of the new pipeline.
     * @return $this
     */
     ...
     * @param \Swagger\Client\Model\APIPipelineStageChange $pipeline_stage_change Initial stage of the pipeline.
     * @return $this
     */
