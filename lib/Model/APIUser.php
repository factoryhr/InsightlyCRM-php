 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class APIUser implements ArrayAccess
{
    /**
    ...
    /**
     * Sets user_id
     * @param int $user_id Unique ID for the user record
     * @return $this
     */
    ...
    /**
     * Sets contact_id
     * @param int $contact_id Unique ID for the Contact record corresponding to the User
     * @return $this
     */
    ...
    /**
     * Sets timezone_id
     * @param string $timezone_id Timezone ID as set by the User in the User's regional settings
     * @return $this
     */
     ...
     * @param string $email_dropbox_identifier Identifier for the User's Email Mailbox
     * @return $this
     */
     ...
     * @param string $email_dropbox_address The User's Email Mailbox address. Derived from the EMAIL_DROPBOX_IDENTIFIER.
     * @return $this
     */
    ...
    /**
     * Sets administrator
     * @param bool $administrator True, if the User is an Administrator for the Insightly instance
     * @return $this
     */
    ...
    /**
     * Sets account_owner
     * @param bool $account_owner True, if the User is the Account owner for the Insightly instance
     * @return $this
     */
    ...
    /**
     * Sets active
     * @param bool $active True, if the account is active
     * @return $this
     */
     ...
     * @param \DateTime $date_created_utc Date and time User record created, as Coordinated Universal Time
     * @return $this
     */
     ...
     * @param \DateTime $date_updated_utc Date and time User record updated, as Coordinated Universal Time
     * @return $this
     */
    ...
    /**
     * Sets user_currency
     * @param string $user_currency User's regional setting for Currency
     * @return $this
     */
     ...
     * @param string $contact_display User's setting for Contact List display
     * @return $this
     */
    ...
    /**
     * Sets contact_order
     * @param string $contact_order User's settting for Contact List order
     * @return $this
     */
     ...
     * @param int $task_week_start User's start day of week
     * @return $this
     */
    ...
    /**
     * Sets instance_id
     * @param int $instance_id Unique key of the Instance which this User belongs to
     * @return $this
     */
