...
/**
 * UserFollow Class Doc Comment
 *
 * @category    Class */
 // @description Information about a followed record.
/** 
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UserFollow implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'UserFollow';
    ...
    /**
     * Sets record_type
     * @param string $record_type Type of the followed record. One of the following: EMAIL, NOTE, TASK, CONTACT, ORGANISATION, PROJECT, OPPORTUNITY, LEAD.
     * @return $this
     */
    ...
    /**
     * Sets record_id
     * @param int $record_id ID of the followed record.
     * @return $this
     */
