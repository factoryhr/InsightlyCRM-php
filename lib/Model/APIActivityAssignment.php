...
class APIActivityAssignment implements ArrayAccess
{
     ...
     * @param int $responsible_user_id Responsible User ID. Either RESPONSIBLE_USER_ID or ASSIGNED_TEAM_ID is required
     * @return $this
     */
     ...
     * @param int $assigned_team_id Assigned Team ID. Either ASSIGNED_TEAM_ID or RESPONSIBLE_USER_ID is required
     * @return $this
     */
