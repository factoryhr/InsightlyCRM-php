 ...
 *
 * @category    Class */
 // @description APICustomFieldMetadata
/** 
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
...
class APICustomFieldMetadata implements ArrayAccess
{
     ...
     * @param string $custom_field_id Unique ID for the custom field record
     * @return $this
     */
    ...
    /**
     * Sets order_id
     * @param int $order_id ORDER_ID is required
     * @return $this
     */
    ...
    /**
     * Sets field_for
     * @param string $field_for The type of object this custom field is for: Contact, Organisation, Project or Opportunity
     * @return $this
     */
    ...
    /**
     * Sets field_type
     * @param string $field_type The type of data this custom field holds: text, date or dropdown
     * @return $this
     */
     ...
     * @param string $field_help_text Help text that appears next to the custom field in the UI.
     * @return $this
     */
    public function setFieldHelpText($field_help_text)
    {
        if (strlen($field_help_text) > 1000) {
    ...
    /**
     * Sets group_id
     * @param int $group_id Unique key of the custom field group
     * @return $this
     */
    ...
    /**
     * Sets editable
     * @param bool $editable Whether or not the field is editable
     * @return $this
     */
    ...
    /**
     * Sets visible
     * @param bool $visible Whether or not the field is visible
     * @return $this
     */
     ...
     * @param \Swagger\Client\Model\APICustomFieldOption[] $custom_field_options A list of option values for a dropdown Custom Field
     * @return $this
     */
