...
class TeamMember implements ArrayAccess
{
    ...
    /**
     * Sets permission_id
     * @param int $permission_id Unique ID for the Team Member record
     * @return $this
     */
    ...
    /**
     * Sets team_id
     * @param int $team_id The unique ID for the Team the team membership record describes
     * @return $this
     */
    ...
    /**
     * Sets member_user_id
     * @param int $member_user_id The unique ID for the User the team membership record describes
     * @return $this
     */
