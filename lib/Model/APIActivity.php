 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class APIActivity implements ArrayAccess
{
    /**
    ...
    /**
     * Sets activity_id
     * @param int $activity_id Unique ID for the Activity
     * @return $this
     */
    ...
    /**
     * Sets activityset_id
     * @param int $activityset_id Unique ID for the Activity Set record that this Activity belongs to
     * @return $this
     */
    ...
    /**
     * Sets activity_name
     * @param string $activity_name The name for the Activity
     * @return $this
     */
     ...
     * @param string $activity_details The details for the Activity
     * @return $this
     */
    ...
    /**
     * Sets category_id
     * @param int $category_id The unique ID for the category associated with the Activity. Only applicable if the ACTIVITY_TYPE is set to TASK.
     * @return $this
     */
    ...
    /**
     * Sets reminder
     * @param bool $reminder Whether or not a reminder is set on the Activity. Only applicable if the ACTIVITY_TYPE is set to TASK.
     * @return $this
     */
     ...
     * @param int $reminder_days_before_due Number of days before due date of the Activity a reminder will be sent out. Only applicable if the ACTIVITY_TYPE is set to TASK.
     * @return $this
     */
    ...
    /**
     * Sets reminder_time
     * @param string $reminder_time The time when a reminder will be sent out for the Activity. Only applicable if the ACTIVITY_TYPE is set to TASK.
     * @return $this
     */
     ...
     * @param bool $publicly_visible Whether the Activity is publicly visible.
     * @return $this
     */
    ...
    /**
     * Sets owner_visible
     * @param bool $owner_visible Whether the Activity is visible to the Owner.
     * @return $this
     */
     ...
     * @param int $responsible_user_id The unique ID for the Responsible User of the Activity. Only applicable if the ACTIVITY_TYPE is set to TASK.
     * @return $this
     */
     ...
     * @param int $assigned_team_id The unique ID for the Responsible Team of the Activity. Only applicable if the ACTIVITY_TYPE is set to TASK.
     * @return $this
     */
    ...
    /**
     * Sets skip_sun
     * @param bool $skip_sun Whether or not to skip scheduling of this Activity on a Sunday.
     * @return $this
     */
    ...
    /**
     * Sets skip_mon
     * @param bool $skip_mon Whether or not to skip scheduling of this Activity on a Monday.
     * @return $this
     */
    ...
    /**
     * Sets skip_tue
     * @param bool $skip_tue Whether or not to skip scheduling of this Activity on a Tuesday.
     * @return $this
     */
    ...
    /**
     * Sets skip_wed
     * @param bool $skip_wed Whether or not to skip scheduling of this Activity on a Wednesday.
     * @return $this
     */
    ...
    /**
     * Sets skip_thu
     * @param bool $skip_thu Whether or not to skip scheduling of this Activity on a Thursday.
     * @return $this
     */
    ...
    /**
     * Sets skip_fri
     * @param bool $skip_fri Whether or not to skip scheduling of this Activity on a Friday.
     * @return $this
     */
    ...
    /**
     * Sets skip_sat
     * @param bool $skip_sat Whether or not to skip scheduling of this Activity on a Saturday.
     * @return $this
     */
     ...
     * @param int $due_days_after_start Determines the due date based on number of days after the Activity Set is created. Only applicable if the ACTIVITY_TYPE is set to TASK.
     * @return $this
     */
     ...
     * @param int $due_days_before_end Determines the due date based on number of days before the Activity Set ends. Only applicable if the ACTIVITY_TYPE is set to TASK.
     * @return $this
     */
     ...
     * @param int $event_days_after_start Determines the event date based on number of days after the Activity Set is created. Only applicable if the ACTIVITY_TYPE is set to EVENT.
     * @return $this
     */
     ...
     * @param int $event_days_before_end Determines the event date based on number of days before the Activity Set ends. Only applicable if the ACTIVITY_TYPE is set to EVENT.
     * @return $this
     */
    ...
    /**
     * Sets event_time
     * @param string $event_time The time of the event. Only applicable if the ACTIVITY_TYPE is set to EVENT.
     * @return $this
     */
    ...
    /**
     * Sets all_day
     * @param bool $all_day Whether or not the event is an all day event. Only applicable if the ACTIVITY_TYPE is set to EVENT.
     * @return $this
     */
    ...
    /**
     * Sets duration
     * @param int $duration Duration of the event in hours. Only applicable if the ACTIVITY_TYPE is set to EVENT.
     * @return $this
     */
