 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContactDate implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ContactDate';
    ...
    public function setOccasionName($occasion_name)
    {
        if (strlen($occasion_name) > 255) {
            throw new \InvalidArgumentException('invalid length for $occasion_name when calling ContactDate., must be smaller than or equal to 255.');
        }
        if (strlen($occasion_name) < 0) {
            throw new \InvalidArgumentException('invalid length for $occasion_name when calling ContactDate., must be bigger than or equal to 0.');
        }
