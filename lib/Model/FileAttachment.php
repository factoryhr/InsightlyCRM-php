...
/**
 * FileAttachment Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FileAttachment implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'FileAttachment';
    ...
    public function setFileName($file_name)
    {
        if (strlen($file_name) > 500) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling FileAttachment., must be smaller than or equal to 500.');
        }
        if (strlen($file_name) < 0) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling FileAttachment., must be bigger than or equal to 0.');
        }
    ...
    public function setContentType($content_type)
    {
        if (strlen($content_type) > 255) {
            throw new \InvalidArgumentException('invalid length for $content_type when calling FileAttachment., must be smaller than or equal to 255.');
        }
        if (strlen($content_type) < 0) {
            throw new \InvalidArgumentException('invalid length for $content_type when calling FileAttachment., must be bigger than or equal to 0.');
        }
