...
class Organisation implements ArrayAccess
{
    ...
    public function setOrganisationName($organisation_name)
    {
        if (strlen($organisation_name) > 255) {
            throw new \InvalidArgumentException('invalid length for $organisation_name when calling Organisation., must be smaller than or equal to 255.');
        }
        if (strlen($organisation_name) < 0) {
            throw new \InvalidArgumentException('invalid length for $organisation_name when calling Organisation., must be bigger than or equal to 0.');
        }
    ...
    public function setBackground($background)
    {
        if (strlen($background) > 4000) {
            throw new \InvalidArgumentException('invalid length for $background when calling Organisation., must be smaller than or equal to 4000.');
        }
        if (strlen($background) < 0) {
            throw new \InvalidArgumentException('invalid length for $background when calling Organisation., must be bigger than or equal to 0.');
        }
