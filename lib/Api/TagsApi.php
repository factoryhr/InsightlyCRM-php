...
class TagsApi
{
     ...
     *
     * @param string $record_type Required, filters tags by a given record type. (required)
     ...
     */
    public function getTags($record_type, $skip = null, $top = null, $count_total = null)
    {
        list($response) = $this->getTagsWithHttpInfo($record_type, $skip, $top, $count_total);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getTagsWithHttpInfo($record_type, $skip = null, $top = null, $count_total = null)
    {
        // verify the required parameter 'record_type' is set
        if ($record_type === null) {
            throw new \InvalidArgumentException('Missing the required parameter $record_type when calling getTags');
        }
        // parse inputs
        $resourcePath = "/Tags";
        $httpBody = '';
