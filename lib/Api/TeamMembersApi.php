...
class TeamMembersApi
{
     ...
     */
    public function addTeamMember($api_team_member)
    {
        list($response) = $this->addTeamMemberWithHttpInfo($api_team_member);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function addTeamMemberWithHttpInfo($api_team_member)
    {
    ...
    {
        list($response) = $this->deleteTeamMemberWithHttpInfo($id);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function deleteTeamMemberWithHttpInfo($id)
    {
    ...
    {
        list($response) = $this->getTeamMemberWithHttpInfo($id);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getTeamMemberWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getTeamMember');
        }
        // parse inputs
        $resourcePath = "/TeamMembers/{id}";
        $httpBody = '';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getTeamMembers($skip = null, $top = null, $count_total = null)
    {
        list($response) = $this->getTeamMembersWithHttpInfo($skip, $top, $count_total);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getTeamMembersWithHttpInfo($skip = null, $top = null, $count_total = null)
    {
        // parse inputs
        $resourcePath = "/TeamMembers";
        $httpBody = '';
