...
class FollowsApi
{
     ...
     */
    public function getFollows($record_type = null, $skip = null, $top = null, $count_total = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getFollowsWithHttpInfo($record_type = null, $skip = null, $top = null, $count_total = null)
    {
        // parse inputs
        ...
        // query params
        if ($record_type !== null) {
            $queryParams['record_type'] = $this->apiClient->getSerializer()->toQueryValue($record_type);
        }
        // query params
        if ($skip !== null) {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\UserFollow[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\UserFollow[]', $e->getResponseHeaders());
