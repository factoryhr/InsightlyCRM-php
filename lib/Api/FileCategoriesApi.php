...
class FileCategoriesApi
{
    ...
    public function addFileCategoryWithHttpInfo($category)
    {
        ...
        if ($category === null) {
            throw new \InvalidArgumentException('Missing the required parameter $category when calling addFileCategory');
        }
        // parse inputs
    ...
    {
        list($response) = $this->deleteFileCategoryWithHttpInfo($id);
        return $response;
    }
    ...
    public function deleteFileCategoryWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling deleteFileCategory');
        }
        // parse inputs
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getFileCategories($skip = null, $top = null, $count_total = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getFileCategoriesWithHttpInfo($skip = null, $top = null, $count_total = null)
    {
        // parse inputs
        $resourcePath = "/FileCategories";
        $httpBody = '';
    ...
    public function getFileCategoryWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getFileCategory');
        }
        // parse inputs
        $resourcePath = "/FileCategories/{id}";
        $httpBody = '';
    ...
    public function updateFileCategoryWithHttpInfo($category)
    {
        // verify the required parameter 'category' is set
        if ($category === null) {
            throw new \InvalidArgumentException('Missing the required parameter $category when calling updateFileCategory');
        }
        // parse inputs
        $resourcePath = "/FileCategories";
        $httpBody = '';
