...
class RelationshipsApi
{
     ...
     */
    public function getRelationships($skip = null, $top = null, $count_total = null)
    {
        list($response) = $this->getRelationshipsWithHttpInfo($skip, $top, $count_total);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getRelationshipsWithHttpInfo($skip = null, $top = null, $count_total = null)
    {
        // parse inputs
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Relationship[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Relationship[]', $e->getResponseHeaders());
