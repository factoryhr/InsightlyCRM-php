...
class EventsApi
{
    ...
    public function addEventLinkWithHttpInfo($id, $api_link)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\EventLink', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updateEventLink($id, $api_link)
    {
        list($response) = $this->updateEventLinkWithHttpInfo($id, $api_link);
        return $response;
    }

    /**
     * Operation updateEventLinkWithHttpInfo
     *
     * Updates an Event Link
     *
     * @param int $id An Event&#39;s ID (EVENT_ID) (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updateEventLinkWithHttpInfo($id, $api_link)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateEventLink');
        }
        // verify the required parameter 'api_link' is set
        if ($api_link === null) {
            throw new \InvalidArgumentException('Missing the required parameter $api_link when calling updateEventLink');
        }
        // parse inputs
        $resourcePath = "/Events/{id}/EventLinks";
        $httpBody = '';
