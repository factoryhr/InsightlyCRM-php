...
class NotesApi
{
    ...
    public function addNoteLinkWithHttpInfo($id, $api_link)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\NoteLink', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updateNoteLink($id, $api_link)
    {
        list($response) = $this->updateNoteLinkWithHttpInfo($id, $api_link);
        return $response;
    }

    /**
     * Operation updateNoteLinkWithHttpInfo
     *
     * Updates an Note Link
     *
     * @param int $id A Note&#39;s ID (NOTE_ID) (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updateNoteLinkWithHttpInfo($id, $api_link)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateNoteLink');
        }
        // verify the required parameter 'api_link' is set
        if ($api_link === null) {
            throw new \InvalidArgumentException('Missing the required parameter $api_link when calling updateNoteLink');
        }
        // parse inputs
        $resourcePath = "/Notes/{id}/NoteLinks";
        $httpBody = '';
